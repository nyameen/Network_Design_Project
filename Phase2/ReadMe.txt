...
The code should be in separate directory from the spongebob.bmp picture.

2) To run the the program, first run make sure the picture is in the directory before the Phase 2 code. Run the python script called GUI.py by issuing the command 
"python GUI.py". The default path for the picture is ../spongebob.bmp. Make sure it is in the path behind as said before.
